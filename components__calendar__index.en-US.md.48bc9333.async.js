...
.notes-month section {
  font-size: 28px;
}`}},{demo:{id:"components-calendar-demo-card"},previewerProps:{title:"Card",filename:"components/calendar/demo/card.tsx",jsx:`import { Calendar } from 'antd';
const App = () => {
  const onPanelChange = (value, mode) => {
    console.log(value.format('YYYY-MM-DD'), mode);
  };
...
`,description:"<p>Nested inside a container element for rendering in limited space.</p>",style:`.site-calendar-demo-card {
  ...
  border-radius: 8px;
}`}},{demo:{id:"components-calendar-demo-select"},previewerProps:{title:"Selectable Calendar",filename:"components/calendar/demo/select.tsx",jsx:`import { Alert, Calendar } from 'antd';
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-customize-header"},previewerProps:{title:"Customize Header",filename:"components/calendar/demo/customize-header.tsx",jsx:`import { Calendar, Col, Radio, Row, Select, Typography } from 'antd';
import dayjs from 'dayjs';
