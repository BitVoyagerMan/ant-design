...
.tag-input {
  ...
  margin-right: 8px;
  vertical-align: top;
}`}},{demo:{id:"components-tag-demo-checkable"},previewerProps:{title:"Checkable",filename:"components/tag/demo/checkable.tsx",jsx:`import { Tag } from 'antd';
...
`,description:'<p>Animating the Tag by using <a href="https://github.com/react-component/tween-one">rc-tween-one</a>.</p>',style:`.site-tag-plus {
  background: #fff;
  border-style: dashed;
}`}},{demo:{id:"components-tag-demo-icon"},previewerProps:{title:"Icon",filename:"components/tag/demo/icon.tsx",jsx:`import {
  FacebookOutlined,
  LinkedinOutlined,
  TwitterOutlined,
  YoutubeOutlined,
